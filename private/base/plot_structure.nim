...
proc pS_rnaPlotSnoopA*(string: cstring; structure: cstring; ssfile: cstring;
                      relativeAccess: ptr cint; seqs: ptr cstring): cint {.cdecl,
    importc: "PS_rna_plot_snoop_a", dynlib: rnaLib.}

proc vrnaFilePS_rnaplot*(seq: cstring; structure: cstring; file: cstring;
                        mdP: ptr VrnaMdT): cint {.cdecl,
    importc: "vrna_file_PS_rnaplot", dynlib: rnaLib.}

proc vrnaFilePS_rnaplotA*(seq: cstring; structure: cstring; file: cstring;
